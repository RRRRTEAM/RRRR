...
if result.id_ == tonumber(1264922434,1033028167) then
...
if userid == tonumber(1264922434,1033028167) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBoykA(msg) then
function Function_BoykA(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevBoykA(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevBoykA(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","✫: تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBoykA(msg) then
function Function_BoykA(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevBoykA(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevBoykA(msg) then
...
function Function_BoykA(extra, result, success)
if result.sender_user_id_ == tonumber(1264922434,1033028167) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
return false
                    ...
                    if Addictive(msg) then
                        database:set(bot_id .. "BoykA:Link_Group" .. msg.chat_id_, true)
...
return false
                    ...
                    if Addictive(msg) then
                        database:del(bot_id .. "BoykA:Link_Group" .. msg.chat_id_)
...
return false
                    ...
                    local status_Link = database:get(bot_id .. "BoykA:Link_Group" .. msg.chat_id_)
                    if not status_Link then
                        send(msg.chat_id_, msg.id_, "܂✫: جلب الرابط معطل")
                        return false
                    end
                    local link = database:get(bot_id .. "BoykA:Private:Group:Link" .. msg.chat_id_)
                    if link then
...
return false
                    ...
                    if Addictive(msg) then
                        ...
                        database:del(bot_id .. "BoykA:Private:Group:Link" .. msg.chat_id_)
                        return false
                    end
                    return false
                end
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevBoykA(msg) then 
...
if text == ("ردود المطور") and DevBoykA(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✫: قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevBoykA(msg) then 
send(msg.chat_id_, msg.id_,"✫:  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevBoykA(msg) then 
...
if text == "تنظيف الكروبات" and DevBoykA(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/BOYKA-DeV/files_BoykA/main/files_BoykA/"..file)
if res == 200 then
...
if text == 'وضع كليشه المطور' and DevBoykA(msg) then
